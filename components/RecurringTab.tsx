...
export default function RecurringTab() {
  ...
  // ── Auto-generate saat komponen mount ──────────────────────────────────
  ...
  const handleAdd = async (e: React.FormEvent) => {
    ...
    if (frequency === 'yearly') {
      body.month_of_year = parseInt(monthOfYear)
    }
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ── Banner: transaksi berhasil di-generate ───────────────────── */}
      <AnimatePresence>
      ...
      <div className="stitched-card p-6 rounded-2xl">
        ...
        >
          ...
          <span>Tambah Jadwal Transaksi Berulang</span>
        </h2>
        ...
        {accounts.length === 0 || categories.length === 0 ? (
          ...
          <form onSubmit={handleAdd} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              ...
              {/* Tanggal hari (monthly/yearly) */}
              {(frequency === 'monthly' || frequency === 'yearly') && (
                <div>
                  <label className="form-label">
                    Tanggal{frequency === 'yearly' ? ' dalam Bulan' : ''} <span className="text-amber-500">*</span>
                  </label>
                  <input
                    type="number"
                    required
                  ...
                  <p className="text-[11px] text-slate-400 mt-1">
                    Tanggal 29–31 akan otomatis menyesuaikan ke hari terakhir bulan jika bulan pendek.
                  </p>
                </div>
              )}
            ...
            >
              ...
              <span>
                ...
                <strong className="text-slate-800">{amount ? formatRupiah(parseFloat(amount)) : 'Rp …'}</strong>
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-[11px] text-slate-400 mt-0.5 flex items-center gap-1.5 flex-wrap">
                          ...
                          {s.accounts && <><span>·</span><span>{s.accounts.name}</span></>}
                          {s.categories && <><span>·</span><span>{s.categories.name}</span></>}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 sm:justify-end shrink-0">
                      <span
                        className={`font-bold text-sm font-number-mono ${
                          s.type === 'income' ? 'text-[#2F9E6E]' : 'text-[#D14343]'
                        }`}
                      >
                  ...
                  {/* Footer: tanggal mulai / akhir / last generated */}
